...
-- Fix Activity Logs Relationship (Just in case)
...
-- 1. Drop ALL existing versions of create_student_user_v2 to avoid ambiguity
DO $$
DECLARE
    r RECORD;
BEGIN
...
-- 2. Create V2 function to bypass any existing signature conflicts
